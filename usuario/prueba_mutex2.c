...
int main(){
	...
	printf("prueba_mutex duerme 1 seg.: ejecutaran los procesos mutex1 y mutex2 que se bloquearan en lock de mutex\n");
	dormir(1);
	...
	printf("prueba_mutex duerme 1 seg.: no ejecutara ningun proceso ya que los mutex estan bloqueados\n");
	dormir(1);
	...
	printf("prueba_mutex termina: debe ejecutar mutex2 ya que el cierre implicito de m1 debe despertarlo y mutex1 esta dormido\n");

...
struct lapic_info {
	...
	uint32_t ID;
	uint32_t relleno[3];
	uint32_t version_num:8; // nº versión: 8 bits de menor peso
	uint32_t version_resto:24; // resto no usado por el programa
	// ... no accedidos por el programa
};
